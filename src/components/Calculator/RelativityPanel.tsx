        ...
        <>
            ...
            <div className="flex justify-between items-start gap-3">
              <div className="flex-1 min-w-0">
                ...
                <p className="text-white/40 text-[10px] mt-1 leading-snug">
                  ...
                  view traces the shape of this rotation — how much of a
                  trajectory tachyonic matter actually follows is an open
                  question, so we render the ship along it.
                </p>
              </div>
          ...
          <div>
            ...
            <p className="text-white/35 text-[10px] mt-2 leading-snug">
              L is the displacement in ordinary space; L·√(v²/c²−1) is
              what length contraction gives when γ is imaginary. Both
              are real numbers that fall out of the math — what they
              correspond to physically is part of the unsolved question
              of what tachyonic matter would be.
            </p>
          </div>
          ...
          <div className="bg-sw-blue/5 border border-sw-blue/10 rounded px-3 py-2">
            ...
            <ul className="text-white/55 text-[11px] leading-relaxed list-disc pl-4 space-y-1">
              ...
              <li>
                <span className="text-white/75">Tachyonic matter is
                unsolved.</span> Whether anything actually traces the arc
                — or whether v &gt; c is a hard binary threshold the ship
                simply jumps across — is not settled. We draw the ship
                along the half-ellipse because it reads the imaginary-γ
                contraction geometrically; treat it as sci-fi license, not
                a prediction.
              </li>
              <li>
